...
2. **Phạm vi ảnh hưởng** — File, module, layer (frontend/backend), API/DB/UI bị ảnh hưởng. Nếu dự án có test hoặc view thì **bổ sung** vào đây (vd. thư mục test, file view/template liên quan).
